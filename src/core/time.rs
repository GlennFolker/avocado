...
impl Time {
    ...
    #[inline]
    pub fn total_paused_sec(&self) -> f32 {
        self.total_paused_sec as f32
    }

    #[inline]
    pub fn delta_sec(&self) -> f32 {
        self.delta_sec as f32
    }

    #[inline]
    pub fn elapsed_sec(&self) -> f32 {
        self.elapsed_sec as f32
    }

    #[inline]
    pub fn elapsed_no_pause_sec(&self) -> f32 {
        self.elapsed_no_pause_sec as f32
    }

    #[inline]
    pub fn total_paused_sec_f64(&self) -> f64 {
        self.total_paused_sec
    }

    #[inline]
    pub fn delta_sec_f64(&self) -> f64 {
        self.delta_sec
    }
    ...
    #[inline]
    pub fn elapsed_no_pause_sec_f64(&self) -> f64 {
