...
pub trait AssetDyn: 'static + Downcast + TypeUuidDyn + Debug + Send + Sync {}
impl_downcast!(AssetDyn);

impl<T: TypeUuid + AssetDyn> Asset for T {}
impl<T: 'static + Downcast + TypeUuidDyn + Debug + Send + Sync> AssetDyn for T {}
